!function (t, e) {
    ...
    function It(t, e) {
        ...
        H(l, e, "header"), qt(0, e), n = t, o = e, (r = Pt.innerParams.get(n)) && o.icon === r.icon && w() ? H(w(), o, "icon") : (Rt(), o.icon && (-1 !== Object.keys(K).indexOf(o.icon) ? (i = y(".".concat(W.icon, ".").concat(K[o.icon])), et(i), Dt(i, o), Ht(), H(i, o, "icon"), pt(i, o.showClass.icon)) : U('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(o.icon, '"')))), function (t) {
            var e = x();
    ...
    var Ee = function (t, e) {
        ...
        }, Ne = ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"], Ue = ["Escape", "Esc"],
        _e = function (t, e, n) {
            ...
            for (var e = t.target, n = q(), o = -1, i = 0; i < n.length; i++) if (e === n[i]) {
                o = i;
                break
            }
    ...
    var en, nn = function (t) {
        ...
        }, close: de, closePopup: de, closeModal: de, closeToast: de, enableButtons: function () {
    ...
    }), rn.DismissReason = z, rn.version = "9.14.4";
    var an = rn;
