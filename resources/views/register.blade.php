        ...
        <div class="form-container">
          ...
          <form action="" autocomplete="off" method="post">
            <div class="row inner-form-container">
              ...
              <div class="col-12">
                <h3 class="spn-h3">Sponsor</h3>
              </div>
              <div class="form-group col-xl-12 col-lg-12 col-md-12 sponsor">
                <input type="text" id="sponsor" placeholder="Your Sponsor Id" class="form-control" />
              </div>

              <div class="col-xl-12 text-center terms-conditions text-uppercase">
                By joining, you agree to our
                <div class="link">
                  <a href="terms_and_conditions.blade.php">TERMS AND CONDITIONS</a>
                </div>
              </div>
              ...
              <div class="col-xl-12 text-center terms-conditions">
                Have an account? <a href="login.blade.php">Login</a>
                or go to
                <a href="/">Home</a>
              </div>
            </div>
